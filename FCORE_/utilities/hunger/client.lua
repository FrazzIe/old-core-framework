...
Citizen.CreateThread(function()
    while true do
        ...
        if(IsPedInAnyVehicle(GetPlayerPed(-1), false))then
	        ...
	        local currentfuel = DecorGetInt(cVeh, "_Fuel_Level") * 0.001
	        ...
	        DrawRect(0.1215 + (currentfuel/2898.55072464)/2,0.8,currentfuel/2898.55072464,0.008295,255, 206, 30,fualpha)
